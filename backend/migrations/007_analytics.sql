...
-- Agrega tablas para tracking de analytics de eventos.
--
-- Para aplicar en un DB existente:
--   docker exec -i milegame-db psql -U user -d milegame < backend/migrations/007_analytics.sql
...
-- ============================================
-- Quiz Events Tracking (para funnel y timeline)
-- ============================================
CREATE TABLE IF NOT EXISTS quiz_events (
    ...
    score INTEGER, -- solo para 'completed'
    time_spent_seconds INTEGER, -- tiempo total en el quiz
...
CREATE TABLE IF NOT EXISTS postcard_events (
    ...
    event_type VARCHAR(50) NOT NULL, -- 'created', 'viewed'
    created_at TIMESTAMP NOT NULL DEFAULT NOW()
);
...
-- ============================================
-- Funciones de ayuda para analytics
-- ============================================

-- Función para registrar inicio de quiz
...
-- Función para registrar completación de quiz
...
-- Trigger para auto-registrar page views básicos
-- (Este trigger registra cada request a páginas de evento)
-- Nota: Implementar a nivel aplicación para más control
