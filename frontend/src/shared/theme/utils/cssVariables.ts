 ...
 * 
 * Converts Theme objects to CSS custom properties for use in components.
 * Generates variables for colors, typography, spacing, radius, and shadows.
 */
 ...
 * @returns Record of CSS variable name to value
 * 
 * @example
 * const vars = generateCSSVariables(theme)
 * // { '--color-primary': '#D22E7F', '--spacing-4': '1rem', ... }
 */
 ...
 * 
 * @param theme - Complete Theme object
 * @returns Cleanup function to remove applied variables
 * 
 * @example
 * const cleanup = applyCSSVariables(theme)
 * // Variables are now available in CSS
 * // Later...
 ...
 * 
 * @param theme - Complete Theme object
 * @returns CSS string for :root with all variables
 * 
 * @example
 * const css = generateCSSString(theme)
 * // ":root {\n  --color-primary: #D22E7F;\n  ...\n}"
 */
