...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-[85vh] flex items-center justify-center px-4 py-16 overflow-hidden">
      ...
      {/* Decorative elements */}
      <div className="absolute top-20 left-10 w-32 h-32 bg-pink-300/30 rounded-full blur-3xl" />
      <div className="absolute bottom-20 right-10 w-40 h-40 bg-rose-300/30 rounded-full blur-3xl" />
      <div className="absolute top-1/3 right-1/4 w-24 h-24 bg-pink-200/40 rounded-full blur-2xl" />
      ...
      >
        ...
        <motion.div variants={itemVariants} className="mb-6">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm rounded-full shadow-sm border border-pink-100 dark:border-slate-700">
        ...
        <motion.p
          variants={itemVariants}
          className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 mb-4 font-serif"
        >
        ...
        <motion.p
          variants={itemVariants}
          className="text-base md:text-lg text-gray-500 dark:text-gray-400 mb-10 max-w-2xl mx-auto"
        >
        ...
        >
          <Button
            ...
            className="w-full sm:w-auto px-8 py-4 text-lg bg-gradient-to-r from-pink-500 to-rose-500 hover:from-pink-600 hover:to-rose-600 shadow-lg shadow-pink-200 dark:shadow-pink-900/50"
          >
          ...
          <Button
            ...
            variant="outline"
            className="w-full sm:w-auto px-8 py-4 text-lg border-2 border-pink-300 dark:border-pink-700 hover:bg-pink-50 dark:hover:bg-pink-900/30"
          >
        ...
        >
          <div>
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">Eventos creados</p>
          </div>
          <div className="w-px h-12 bg-pink-200 dark:bg-slate-700 hidden sm:block" />
          <div>
            <p className="text-3xl font-bold text-pink-600 dark:text-pink-400">50+</p>
            <p className="text-sm text-gray-500 dark:text-gray-400">Invitados por evento</p>
          </div>
          <div className="w-px h-12 bg-pink-200 dark:bg-slate-700 hidden sm:block" />
          <div>
            <p className="text-3xl font-bold text-pink-600 dark:text-pink-400">4.9★</p>
