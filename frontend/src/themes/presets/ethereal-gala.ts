/**
 * Ethereal Gala Theme Preset
 * Elegant, romantic theme with soft pink tones
 */
...
const secondaryColor = '#FBCFE8';
const accentColor = '#DB2777';
const bgColor = '#FFF5F7';
...
export const etherealGala: ThemePreset = {
  id: 'ethereal-gala',
  name: 'ethereal-gala',
  label: 'Ethereal Gala',
  description: 'Romantic and elegant with soft pink tones, perfect for weddings and celebrations',
