/**
 * Kids Carnival Theme Preset
 * Fun and colorful theme for children's parties
 */
...
const theme: Theme = {
  ...
  typography: {
    displayFont: 'Bubblegum Sans, cursive',
    headingFont: 'Comic Neue, cursive',
...
export const kidsCarnival: ThemePreset = {
  id: 'kids-carnival',
  name: 'kids-carnival',
  label: 'Kids Carnival',
  description: 'Fun and colorful with green tones, perfect for children\'s birthday parties',
